...
import { Typography, Button, Dialog,TextField, Grid } from '@material-ui/core'
...
const YarnInformation = props => {
    ...
    // const [somethingChanged,setSomethingChanged] = React.useState(0)
    ...
    React.useEffect(()=>{
        // api/yarninformation/fetch/obyarninfo/all
        try {
            fetch(end_point + 'api/yarninformation/fetch/obyarninfo/all', {
                method: 'get',
    ...
    return(<div style={{display:'flex',flexDirection:'column',alignItems:'center'}}>
        ...
        <div>
            <Button variant="contained" color='primary' style={{width:200,margin:'10px'}}>Submit</Button>
        </div>
    </div>)
}
